...
import com.example.backofficeportal.CustomersRepository;
import com.example.backofficeportal.OrdersRepository;
import com.example.backofficeportal.InventoryRepository;
...
class LoadDatabase {
	...
	@Bean 
	CommandLineRunner initDatabase(CustomersRepository customerRepository,
	...
	private void preloadData(CustomersRepository customerRepository,
								   OrdersRepository ordersRepository, 
								   InventoryRepository inventoryRepository) {

		Customers customer1 = new Customers("a", "111");
		Customers customer2 = new Customers("Tim Ducan", "66666");
		Customers customer3 = new Customers("Larry Bird", "431123");
		Customers customer4 = new Customers("Jason Kidd", "123534");
		...
		Orders order1 = new Orders(Long.valueOf(1), "Broccoli * 1; Apple * 2", 50.00, "ORDER CREATED");
		Orders order2 = new Orders(Long.valueOf(3), "Milk * 1; Soda * 2", 60.00, "PENDING");
		Orders order3 = new Orders(Long.valueOf(2), "Soap * 1; Bacon * 2", 90.00, "PENDING");
		Orders order4 = new Orders(Long.valueOf(4), "Milk * 1; Bacon * 2", 40.00, "PENDING");
