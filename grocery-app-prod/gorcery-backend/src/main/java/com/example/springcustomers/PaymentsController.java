...
public class PaymentsController {  
    ...
    public PaymentsCommand checkOut(@RequestBody PaymentsCommand command) {       
        ...
        Orders o = orderServices.findOrderById(p.getOrderid());
        String order_amount = String.valueOf(o.getAmount());
        String order_num = String.valueOf(p.getOrderid());
        ...
        auth.transactionAmount = order_amount;
        ...
        if(authValid)
        {
            ...
            capture.transactionAmount = order_amount;
        ...
        if(authValid && captureValid){
            ...
            command.setTransactionAmount(order_amount);
            ...
            orderService.updateOrderStatus("DELIVERING", o.getId());        
